<template>
	<view>
		<view class="prefer-posi">
			...
			<!-- 阴影效果 -->
			<view class="yin" v-if="yinying" @click="backClick()"></view>
		</view>
	</view>
</template>
...
<style scoped>
	.yin{
		background: rgba(0,0,0,0.5);/* 上下左右都为0就是整个页面都遮挡 */
		position: fixed;
		top: 0;
		left: 0; 
		right: 0;
	...
	.Choice{
		...
		line-height: 55rpx;
		color: #666666;
		width: calc((100/3) - 15rpx) !important;
		margin: 7.5rpx;
		text-align: center;
		display: block;
		border-radius: 6rpx;
	...
	.sortlist-bottom text:nth-child(1){border-right:1rpx solid #e4e4e4;}
